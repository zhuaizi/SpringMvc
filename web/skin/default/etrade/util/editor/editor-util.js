 ...
 * 实例：
 * 	var cfg ={
        //从已有的textarea创建,需保证html有对应id的textarea代码。与render不共用
 ...
 * 		// 是否初始聚焦
  ...
  editor.render(cfg);
  editor.on("afterRender",function(e){//只有使用afterRender事件，才能获取e.editor，e.editor为kissy的editor对象
 
 	e.editor.setData("我的毒辣椒粉的时间发了的fsdfsdfdsfds");
