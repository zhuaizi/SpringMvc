...
KISSY.add("io/base", ["event/custom", "promise"], function(S, require) {
  ...
  converters:{text:{json:S.parseJson, html:mirror, text:mirror, xml:S.parseXML}}, headers:{"X-Requested-With":"XMLHttpRequest",'Client-Type':'Ext'}, contents:{xml:/xml/, html:/html/, json:/json/}};
